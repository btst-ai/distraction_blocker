# timeline-day-navigation Specification

## Purpose
Stable browsing of past timeline days (up to 7 days back) via ◀ / ▶ navigation, with the selected day preserved across auto-refreshes and a visible "time travelling" indicator when the live view is not active.
## Requirements
